...
**目的**：在 AI 開始任何開發工作之前，交叉比對所有規格來源，消除矛盾。
...
規格本身模糊或缺漏的部分（非來源間矛盾，而是所有來源都沒寫清楚），獨立列出。
...
| **不可合併衝突項和 SA 待確認項** | 性質不同：衝突 = 來源間矛盾；SA 待確認 = 所有來源都不清楚 |
