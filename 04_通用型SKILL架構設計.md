...
**動手順序：** P2 改造 → P3 骨架 → P4a + P4b 骨架

| 順序 | 任務 | 說明 |
|------|------|------|
| 1 | P2 通用化改造 | 拉掉 A-F / A-E、改讀 CLAUDE.md 索引、修正 test_cases.md 格式 |
| 2 | P3 SKILL.md 骨架 | TDD 迴圈 + 3 stop gate + 防護機制 |
| 3 | P4a spec-uat SKILL.md 骨架 | 輕量 UAT checklist 流程 |
| 4 | P4b spec-e2e SKILL.md 骨架 | Playwright 自動化 + 自我修復 + 三層防護 |
