...
- [ ] §4 能力邊界表更新 — 加入附和偏見、自我修正盲區的 Layer 對應
- [ ] Token 經濟分析 — 各策略（sub-agent、compaction、KV-cache）的成本效益量化
- [ ] 模型選擇決策框架 — 基於任務特性選擇 Opus/Sonnet/Haiku 的決策樹
- [ ] Agentic 失敗模式的交互效應 — 規格博弈 × 退化迴圈 × 附和偏見的複合風險分析
