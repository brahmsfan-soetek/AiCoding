...
| 廠商 | 模型 | 名義 Context Window | 最大輸出 | 備註 |
|------|------|---------------------|---------|------|
| Anthropic | **Claude Opus 4.6** | **1,000K** | 128K | MRCR v2 @ 1M: **76%**（最佳） |
| Anthropic | **Claude Sonnet 4.6** | **1,000K** | 64K | 1M GA，無長 context 加價 |
| Anthropic | Claude Sonnet 4.5 | 200K（1M 需 beta header） | 64K | 需 `context-1m-2025-08-07` header |
| Anthropic | Claude Haiku 4.5 | 200K | 64K | 無 1M 選項 |
| OpenAI | **GPT-4.1** | **1,048K** | 32K | NIAH 任務最佳，但幻覺率較高 |
| OpenAI | GPT-4.1 mini / nano | 1,048K | 32K | 同架構的輕量版本 |
| OpenAI | GPT-4o | 128K | 16K | — |
| OpenAI | o1 / o3 / o4-mini | 200K | 100K | 推理 token 消耗 context 但不可見 |
| Google | **Gemini 2.5 Pro** | **1,048K** | 64K | Recall: 530K 時 100%，1M 時 99.7% |
| Google | **Gemini 2.5 Flash** | **1,048K** | 64K | 同上，快速低成本 |
| Meta | **Llama 4 Scout** | **10,000K** | — | 開源最大 context，MoE 架構 |
| Meta | Llama 4 Maverick | 1,000K | — | MoE 架構 |
| DeepSeek | DeepSeek V3 / R1 | 128K | 8K（R1: +32K CoT） | 685B 參數，MoE |
| Alibaba | Qwen3.5-Plus | 1,000K | — | Qwen3 原生僅 32K |
| Alibaba | Qwen 2.5 Coder 32B | 131K | 8K | Coding 專用 |
...
有效 context 的經驗法則：
  ...
  名義窗口            有效上限（高品質工作）    建議策略
  ─────────────────────────────────────────────────────────
  128K (GPT-4o 等)     30K-50K                  積極精簡 context
  200K (o3, Haiku 等)  50K-80K                  搭配 context compaction
  1M   (Opus 4.6 等)   100K-200K                大型任務可單 session，
                                                但仍需策劃 context
  1M   (Sonnet 4.5)    50K-80K                  MRCR v2 僅 18.5%，
                                                不適合填滿 context
```
