...
> 來源：[Context Length Alone Hurts LLM Performance (Du et al., Findings of EMNLP 2025)](https://arxiv.org/abs/2510.05381)；[Multi-Doc Summarization Hallucination (Findings of NAACL 2025)](https://arxiv.org/abs/2410.13961)；[Semantic Noise in RAG (arXiv:2505.21870)](https://arxiv.org/html/2505.21870v1)；[Inkeep: Context Engineering (2025)](https://inkeep.com/blog/context-engineering-why-agents-fail)；[Same Task More Tokens (2024)](https://arxiv.org/abs/2402.14848)
...
| 主題 | 關鍵數值 | 來源 |
|------|---------|------|
| 多輪退化 | 平均 39% 效能下降；unreliability 增加 112% [待確認]；兩輪即出現退化 | Laban et al., ICLR 2026 |
