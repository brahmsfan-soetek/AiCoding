...
Context Rot 在多輪對話中有更具體的量化表現。對 200,000+ 模擬對話、15 個模型的實測顯示，將同一任務分散到多輪對話，平均效能下降 **39%**（Laban et al., ICLR 2026）。
...
> 來源：[LLMs Get Lost In Multi-Turn Conversation (Laban et al., ICLR 2026)](https://openreview.net/forum?id=VKGTGGcwl6) — 15 模型、6 任務、200K+ 對話實測
...
| Amazon AI 事故（約一週內 4 個 Sev-1） | AWS Cost Explorer 13hr 中斷、99% 訂單下降 | [CNBC 2026/03](https://www.cnbc.com/2026/03/10/amazon-plans-deep-dive-internal-meeting-address-ai-related-outages.html) | 未驗證即合併的系統性風險 |
...
| 附和偏見 | 98% 被質疑時錯誤承認失誤；PM 95% 偏好附和（vs 基線真實回覆）；使用者暗示降低準確率最高 27% | Sharma et al., ICLR 2024 |
...
| LLMs Get Lost In Multi-Turn Conversation (Laban et al., ICLR 2026) | https://openreview.net/forum?id=VKGTGGcwl6 |
